...
public static class FluentResultsExtensions
{
    ...
    public static bool IsStatusCode(this IError? error, string statusCode)
    {
        ...
        return error?.HasMetadata(Constants.General.Type, val => val.Equals(statusCode)) ?? false;
    }
    ...
    public static IError CreateError(string statusCode, string? message = null)
    {
        ...
        return new Error(message).WithMetadata(Constants.General.Type, statusCode);
    }
    public static IError CreateNotFoundError(string? message = null)
    {
        return new Error(message).WithMetadata(Constants.General.Type, nameof(StatusCodes.Status404NotFound));
    }
