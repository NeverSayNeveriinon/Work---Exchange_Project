...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240729132139_ChangeSomeDataTypes")]
    partial class ChangeSomeDataTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.DefinedAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Domain.Entities.ExchangeValue", b =>
                {
                    ...
                    b.HasIndex("FirstCurrencyId", "SecondCurrencyId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Core.Domain.IdentityEntities.UserProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENacNd1mt+odfWMdoLe6HkyICHLuiJ4sGt54p0IX5bRVpEzWzwGLiLl1UtS9TjDxWA==",
            ...
            modelBuilder.Entity("Core.Domain.Entities.DefinedAccount", b =>
                {
                    b.HasOne("Core.Domain.Entities.CurrencyAccount", "CurrencyAccount")
                        .WithMany("DefinedAccountsJoin")
                        .HasForeignKey("CurrencyAccountNumber")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Core.Domain.IdentityEntities.UserProfile", "UserProfile")
                        .WithMany("DefinedAccountsJoin")
            ...
            modelBuilder.Entity("Core.Domain.Entities.CurrencyAccount", b =>
                {
                    b.Navigation("DefinedAccountsJoin");
